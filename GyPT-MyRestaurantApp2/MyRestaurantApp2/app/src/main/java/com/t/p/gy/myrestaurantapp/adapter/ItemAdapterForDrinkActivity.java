...
import com.t.p.gy.myrestaurantapp.DrinkActivity;
import com.t.p.gy.myrestaurantapp.R;
import com.t.p.gy.myrestaurantapp.data.SingleMenuItem;

import java.util.ArrayList;

public class ItemAdapterForDrinkActivity extends ArrayAdapter<SingleMenuItem> {
    private int mColorResourceID; //hatter szine

    public ItemAdapterForDrinkActivity(Activity context, ArrayList<SingleMenuItem> inputList, int colorResourceID) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        plusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                amountTextView.setText(String.valueOf(currentSingleMenuItem.getOrderAmount()));
                DrinkActivity.refreshSummedPrice();
            }
        });
